...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rubocop/rubocop/issues", "changelog_uri" => "https://github.com/rubocop/rubocop/releases/tag/v1.66.1", "documentation_uri" => "https://docs.rubocop.org/rubocop/1.66/", "homepage_uri" => "https://rubocop.org/", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/rubocop/rubocop/" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<rubocop-ast>.freeze, [">= 1.32.2", "< 2.0"])
    ...
    s.add_dependency(%q<regexp_parser>.freeze, [">= 2.4", "< 3.0"])
    s.add_dependency(%q<rubocop-ast>.freeze, [">= 1.32.2", "< 2.0"])
